...
const SimpleHealthInsightsPanel: React.FC<HealthInsightsProps> = ({ qrCode, batchData, userProfile }) => {
...
export { SimpleHealthInsightsPanel }
export default SimpleHealthInsightsPanel
