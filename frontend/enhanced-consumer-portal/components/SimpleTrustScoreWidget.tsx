...
const SimpleTrustScoreWidget: React.FC<TrustScoreProps> = ({ qrCode, batchData, blockchainData }) => {
    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 py-2 rounded-lg font-medium hover:from-purple-600 hover:to-pink-600 flex items-center transition-all duration-200 hover:scale-105"
        >
      ...
      <div className="flex items-center justify-center mb-8">
        <div className="relative">
          <div className="w-32 h-32 rounded-full border-8 border-gray-200 flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  ...
                  <div className="w-16 bg-gray-200 rounded-full h-2">
                    <div
                      className={`bg-gradient-to-r ${getScoreGradient(factor.score)} h-2 rounded-full transition-all duration-1000`}
...
export { SimpleTrustScoreWidget }
export default SimpleTrustScoreWidget
